...
import com.red21.restdemo.service.impl.CloudVendorServiceImpl;
...
class CloudVendorServiceImplTest {
  ...
  @Mock private CloudVendorRepository cloudVendorRepository;
  ...
  void testGetByVendorName() {
    ...
    assertThat(
        cloudVendorService.getByVendorName("Amazon").get(0).getVendorId())
  ...
  void testGetAllCloudVendors() {
    ...
    assertThat(
        cloudVendorService.getAllCloudVendors().get(0).getVendorPhoneNumber())
